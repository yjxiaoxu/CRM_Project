...
<%@ page import="com.yjxiaoxu.crm.settings.domain.DicValue" %>
<%@ page import="java.util.List" %>
<%@ page import="com.yjxiaoxu.crm.workbench.domain.Tran" %>
...
<%
	...
	Map<String, String> pMap = (Map<String, String>) application.getAttribute("map1");
	Set<String> set = pMap.keySet();
	//定义一个整数形变量，用来保存正常阶段和丢失阶段的分割点
	int point = 0;
	//遍历dvList集合
