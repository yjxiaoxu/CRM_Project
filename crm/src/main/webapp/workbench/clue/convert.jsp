...
<script type="text/javascript">
	$(function(){
		...
		$("#defineBtn").click(function() {
			//选中的单选框对象的值（activityId）
			var activityId = $("input[name=activity]:checked").val();
			//alert($("#"+activityId).html());
			//将被选中的市场活动的名称添加到市场活动源框中
	...
	//获取所有市场活动或者通过市场活动名称模糊查询市场活动
	function getActivityListOrByName() {
		//alert("123");
		//发送ajax请求
		$.ajax({
			url : "workbench/clue/getActivityListOrByName.do",
			data : {
...
<%--							</tr>--%>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" id="defineBtn">确定</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="convertForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" data-toggle="modal" data-target="#searchActivityModal" style="text-decoration: none;"><span class="glyphicon glyphicon-search" id="getActivityBtn"></span></a></label>
